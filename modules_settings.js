...
async function bridge_layerswap(account_id, key, recipient){
...
async function bridge_nitro(account_id, key, recipient){
...
async function swap_zebra(account_id, key, recipient){
...
async function swap_xyswap(account_id, key, recipient){
...
async function deposit_layerbank(account_id, key, recipient){
...
async function deposit_aave(account_id, key, recipient){
...
async function mint_zerius(account_id, key, recipient){
...
async function mint_l2pass(account_id, key, recipient){
...
async function mint_zkstars(account_id, key, recipient){
...
async function send_message(account_id, key, recipient){
...
async function bridge_nft(account_id, key, recipient){
...
async function make_transfer(_id, key, recipient){
...
async function swap_tokens(account_id, key, recipient){
...
async function swap_multiswap(account_id, key, recipient){
...
async function custom_routes(account_id, key, recipient) {
...
async function withdraw_layerbank(account_id, key, recipient){
    layerbank = LayerBank(account_id, key, recipient)
    await layerbank.withdraw()
}

async function withdraw_aave(account_id, key, recipient){
    aave = Aave(account_id, key, recipient)
    await aave.withdraw()
}
...
async function create_safe(account_id, key, recipient){
...
async function rubyscore_vote(account_id, key, recipient){
    rubyscore = RubyScore(account_id, key, recipient)
    await rubyscore.vote()
}

async function nft_origins(account_id, key, recipient){
